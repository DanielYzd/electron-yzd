...
var serviceModule = {
    ...
    //校验物料条码: #曲轴上线
    validCSProductRecord: {
        url: apiBaseUrl + 'pcs/restful/validCSProductRecord',
        method: 'post'
    },
    ...
    onSubmit: function onSubmit() {
      ...
      http(api.logIn, body).then(function (response) {
        ...
        if (response.data.returnCode == "0") {
          var userText = response.data.data.user.userText;
          window.localStorage.setItem("userCode", userText);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2183f677","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/login/login.vue
...
/* scopeId */
var login___vue_scopeId__ = "data-v-2183f677"
/* moduleIdentifier (server only) */
...
var mqttCtrl = function () {
    ...
    return {
         ...
         * 订阅主题
         **/
        subscribe: function subscribe(topic1, topic2, topicGroup) {
            var subscribeOptions = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
            ...
            topicGroup = topicGroup || "default";
            // if (this.existSubscribe(topic1, topicGroup)) {
            //     return;
            // }
            this.connect().then(function () {
                client.subscribe(topic1, subscribeOptions);
                client.subscribe(topic2, subscribeOptions);
                if (!topicGroups[topicGroup]) {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-072b6500","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/index/head.vue
var head_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app-head"},[_c('div',{staticClass:"logo"}),_vm._v(" "),_c('div',{staticClass:"help"}),_vm._v(" "),_c('div',{staticClass:"title"}),_vm._v(" "),_c('div',{staticClass:"out",on:{"click":function($event){_vm.logout()}}},[_vm._v("注销")]),_vm._v(" "),_c('div',{staticClass:"workStationText"},[_vm._v(_vm._s(_vm.workStationText))]),_vm._v(" "),_c('div',{staticClass:"site-pic"}),_vm._v(" "),_c('div',{staticClass:"workStationText"},[_vm._v(_vm._s(_vm.user))]),_vm._v(" "),_c('div',{staticClass:"user-pic"}),_vm._v(" "),_c('div',{staticClass:"light",on:{"click":function($event){_vm.port()}}}),_vm._v(" "),_c('div',{staticClass:"state"},[_vm._v("串口状态：")])])}
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-8a1cc086","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/system/systemconfiguration.vue
...
/* scopeId */
var systemconfiguration___vue_scopeId__ = "data-v-8a1cc086"
/* moduleIdentifier (server only) */
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/load.vue
//
//
//
//
...
/* harmony default export */ var load = ({
  ...
  methods: {
    ...
    subscribe: function subscribe() {
      ...
      var topic2 = "/order/" + siteCode + "/refresh";
      var workStationCode = loc.workStationCode;
      var topic1 = "/logs/" + workStationCode;

      mqtt.subscribe(topic1, topic2, "message");
      mqtt.registerMessageHandler(topic1, "message", function (message) {
      ...
      // let siteCode = loc.siteCode;
      // let topicRefresh = "/order/" + siteCode + "/refresh1";
      // console.log(topicRefresh);
      // mqttLib.subscribe(topicRefresh, "note");
      // mqttLib.registerMessageHandler(topicRefresh, "note", function(
      //   message
      // ) {
      //   let refresh = JSON.parse(message.payloadString);
      //   console.log(refresh);
      //   if (refresh) {
      //     _this.getProcutionOrderQueue();
      //   }
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/load.vue
//
//
//
//
...
/* harmony default export */ var assembly_load = ({
  data: function data() {
    return {
      currentPage: 1, //当前页
      pagesize: 6,
...
/* template functional */
var load___vue_template_functional__ = false
/* styles */
var load___vue_styles__ = load_injectStyle
/* scopeId */
var load___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var load___vue_module_identifier__ = null
var load_Component = load_normalizeComponent(
  assembly_load,
  views_assembly_load,
  load___vue_template_functional__,
  load___vue_styles__,
  load___vue_scopeId__,
  load___vue_module_identifier__
)

/* harmony default export */ var src_views_assembly_load = (load_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/initialize.vue
//
//
//
//
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/initialize.vue
//
//
//
//
...
/* harmony default export */ var assembly_initialize = ({
  data: function data() {
    return {
      currentPage: 1, //当前页
      pagesize: 6,
...
/* harmony default export */ var src_views_assembly_initialize = (initialize_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/pt/initialize.vue
//
//
//
//
...
/* harmony default export */ var pt_initialize = ({
  data: function data() {
    return {
      currentPage: 1, //当前页
      pagesize: 6,
  ...
  methods: {
    ...
    subscribe: function subscribe() {
      ...
      var siteCode = loc.siteCode;
      var topic2 = "/ptqueue/" + siteCode + "/refresh";
      mqtt.subscribe(topic1, topic2, "message");
      mqtt.registerMessageHandler(topic1, "message", function (message) {
        var data = JSON.parse(message.payloadString);
        console.log(data);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/pt/initialize.vue
//
//
//
//
...
/* harmony default export */ var assembly_pt_initialize = ({
  data: function data() {
    return {
      currentPage: 1, //当前页
      pagesize: 6,
...
/* template functional */
var pt_initialize___vue_template_functional__ = false
/* styles */
var pt_initialize___vue_styles__ = pt_initialize_injectStyle
/* scopeId */
var pt_initialize___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var pt_initialize___vue_module_identifier__ = null
var pt_initialize_Component = pt_initialize_normalizeComponent(
  assembly_pt_initialize,
  views_assembly_pt_initialize,
  pt_initialize___vue_template_functional__,
  pt_initialize___vue_styles__,
  pt_initialize___vue_scopeId__,
  pt_initialize___vue_module_identifier__
)

/* harmony default export */ var src_views_assembly_pt_initialize = (pt_initialize_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/unload.vue
//
//
//
//
...
/* harmony default export */ var unload = ({
  data: function data() {
    return {
      ...
      try {
        ...
        port.open(function (error) {
          if (error) {
            ...
            document.getElementsByClassName("light")[0].style.backgroundColor = "green";
            _this.$message({
              message: "串口打开成功",
              type: "success"
            });
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/unload.vue
//
//
//
//
...
/* harmony default export */ var assembly_unload = ({
  data: function data() {
    return {
      StepDatas: [{ title: "托盘已到位,准备读取数据...", status: "wait" }, { title: "正在读取数据...", status: "wait" }, { title: "读取数据成功,正在上传...", status: "wait" }, { title: "上传成功!", status: "wait" }, { title: "完成报工!", status: "wait" }],
      serialPort: "",
...
/* template functional */
var unload___vue_template_functional__ = false
/* styles */
var unload___vue_styles__ = unload_injectStyle
/* scopeId */
var unload___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var unload___vue_module_identifier__ = null
var unload_Component = unload_normalizeComponent(
  assembly_unload,
  views_assembly_unload,
  unload___vue_template_functional__,
  unload___vue_styles__,
  unload___vue_scopeId__,
  unload___vue_module_identifier__
)

/* harmony default export */ var src_views_assembly_unload = (unload_Component.exports);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/repair.vue
...
/* harmony default export */ var repair = ({
  data: function data() {
    return {
      code: "", //产品序列号
      productionOrderNum: "",
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/repair.vue
...
/* harmony default export */ var assembly_repair = ({
  data: function data() {
    return {
      code: "", //产品序列号
      productionOrderNum: "",
...
/* template functional */
var repair___vue_template_functional__ = false
/* styles */
var repair___vue_styles__ = repair_injectStyle
/* scopeId */
var repair___vue_scopeId__ = "data-v-71c4506c"
/* moduleIdentifier (server only) */
var repair___vue_module_identifier__ = null
var repair_Component = repair_normalizeComponent(
  assembly_repair,
  views_assembly_repair,
  repair___vue_template_functional__,
  repair___vue_styles__,
  repair___vue_scopeId__,
  repair___vue_module_identifier__
)

/* harmony default export */ var src_views_assembly_repair = (repair_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/load.vue
//
//
//
//
...
/* harmony default export */ var machining_load = ({
  data: function data() {
    return {
      centerDialogVisible: false,
      productionOrderNum: "",
  ...
  methods: {
    ...
    validMachiningProductRecord: function validMachiningProductRecord() {
      ...
      if (this.code == "") {
        ...
        http(api.validMachiningProductRecord, body).then(function (response) {
          if (response.data.returnCode == "0") {
            _this4.productCount++;
            if (_this4.productCount == _this4.plannedQty) {
    ...
    currentChange: function currentChange(val) {
      ...
      http(api.getMachingHisRecords, body).then(function (response) {
        var resData = response.data.data;
        _this8.gridData = resData.list;
        _this8.total = resData.toalCount;
      });
    }
  }
});
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/load.vue
//
//
//
//
...
/* harmony default export */ var views_machining_load = ({
  data: function data() {
    return {
      centerDialogVisible: false,
      productionOrderNum: "",
...
/* template functional */
var machining_load___vue_template_functional__ = false
/* styles */
var machining_load___vue_styles__ = machining_load_injectStyle
/* scopeId */
var machining_load___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var machining_load___vue_module_identifier__ = null
var machining_load_Component = machining_load_normalizeComponent(
  views_machining_load,
  selectortype_template_index_0_src_views_machining_load,
  machining_load___vue_template_functional__,
  machining_load___vue_styles__,
  machining_load___vue_scopeId__,
  machining_load___vue_module_identifier__
)

/* harmony default export */ var src_views_machining_load = (machining_load_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/ch/initialize.vue
//
//
//
//
...
/* harmony default export */ var ch_initialize = ({
  data: function data() {
    return {
      serialNo: "",
      proinfo: {},
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/ch/initialize.vue
//
//
//
//
...
/* harmony default export */ var machining_ch_initialize = ({
  data: function data() {
    return {
      serialNo: "",
      proinfo: {},
...
/* template functional */
var ch_initialize___vue_template_functional__ = false
/* styles */
...
var ch_initialize_Component = ch_initialize_normalizeComponent(
  machining_ch_initialize,
  views_machining_ch_initialize,
  ch_initialize___vue_template_functional__,
  ch_initialize___vue_styles__,
  ch_initialize___vue_scopeId__,
  ch_initialize___vue_module_identifier__
)

/* harmony default export */ var src_views_machining_ch_initialize = (ch_initialize_Component.exports);

// EXTERNAL MODULE: ./node_modules/babel-runtime/helpers/defineProperty.js
var defineProperty = __webpack_require__("bOdI");
var defineProperty_default = /*#__PURE__*/__webpack_require__.n(defineProperty);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/hottest.vue
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/assembly/hottest.vue
...
/* harmony default export */ var assembly_hottest = ({
  data: function data() {
    var _ref;
...
/* harmony default export */ var src_views_assembly_hottest = (hottest_Component.exports);

// EXTERNAL MODULE: ./node_modules/timers-browserify/main.js
var main = __webpack_require__("162o");
var main_default = /*#__PURE__*/__webpack_require__.n(main);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/ch/unload.vue
...
/* harmony default export */ var ch_unload = ({
  data: function data() {
    return {
      siteCode: "",
      scanCode: "",
  ...
  methods: {
      ...
      if (this.code != "") {
        http(api.productionMachiningStatusChange, body).then(function (res) {
          if (res.data.returnCode == "0") {
            ...
            //获取打托数
            _this3.trayNumber = res.data.data.trayNumber;
            //获取物料编号
            _this3.materialCode = res.data.data.materialCode;
            _this3.materialText = res.data.data.materialText;
            //查询队列
            _this3.unPrintProductionQueue();
          } else {
            _this3.trayNumber = 0;
            _this3.scan = 0;
            // this.openDialog=true;
            if (res.data.returnCode == "7788") {
    ...
    currentChange: function currentChange(val) {
      ...
      http(api.getMachingOfflineHisRecords, body).then(function (response) {
        var resData = response.data.data;
        _this5.gridData = resData.list;
        _this5.total1 = resData.toalCount;
      });
    },
    ...
    getServertime: function getServertime() {
      ...
      http(api.getServertime).then(function (response) {
        _this6.time = response.data.data;
      });
    },
    ...
    unPrintProductionQueue: function unPrintProductionQueue() {
      ...
      http(api.unPrintProductionQueue, body).then(function (res) {
        ...
        if (_this7.materialCode) {
          console.log(_this7.tableData);
          var count = 0;
          var printArr = [];
          for (var i = 0; i < _this7.tableData.length; i++) {
            if (_this7.materialCode == _this7.tableData[i].materialCode) {
              console.log(_this7.tableData[i]);
              printArr.push(_this7.tableData[i]);
              count++;
            }
          }
          _this7.scan = count;
          if (_this7.scan == _this7.trayNumber) {
            //扫描数量到达打托数，自动打印
            var _body = {
            ...
            _this7.getServertime();
            _this7.antoprint(_body);
          }
        }
      });
    },
    ...
    antoprint: function antoprint(body) {
      ...
      http(api.insertPalletizedRecords, body).then(function (res) {
        if (res.data.returnCode == "0") {
          ...
          _this8.siteCode = JSON.parse(window.localStorage.getItem("terminal")).siteCode;
          _this8.palletBarCode = msg;
          _this8.imgsrc = config.apiBaseUrl + "pcs/restful/getQrCode?msg=" + msg + "&siteCode=" + _this8.siteCode;
          _this8.count = _this8.scan;
          _this8.printmaterialCode = _this8.materialCode;
          _this8.printmaterialText = _this8.materialText;
    ...
    openCom: function openCom() {
      try {
        ...
        parser.on("data", function (data) {
          ...
          } else if (_this.openDialog == false) {
            _this.code = data;
            _this.productionMachiningStatusChange();
          } else if (_this.openDialog == true) {
            _this.scanCode = data;
          }
        });
        _this.serialPort = port;
    ...
    currentChange1: function currentChange1(val) {
      ...
      http(api.getPalletizedRecords, body).then(function (response) {
        _this10.printdata = response.data.data.palletizedRecords;
        _this10.total = response.data.data.toalCount;
      });
    },
        ...
        if (count > 0) {
          ...
          http(api.insertPalletizedRecords, body).then(function (res) {
            ...
            if (res.data.returnCode = "0") {
              ...
              var msg = res.data.data;
              _this11.siteCode = JSON.parse(window.localStorage.getItem("terminal")).siteCode;
              _this11.palletBarCode = msg;
              _this11.imgsrc = config.apiBaseUrl + "pcs/restful/getQrCode?msg=" + msg + "&siteCode=" + _this11.siteCode;
              _this11.count = _this11.multipleSelection.length;
              _this11.printmaterialCode = _this11.multipleSelection[0].materialCode;
              _this11.printmaterialText = _this11.multipleSelection[0].materialText;
              _this11.$nextTick(function () {
                console.log(document.getElementById("print"));
                _this11.print();
              });
              console.log(_this11.materialCode);
              _this11.unPrintProductionQueue();
            }
          });
        }
      } else {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/ch/unload.vue
...
/* harmony default export */ var machining_ch_unload = ({
  data: function data() {
    return {
      siteCode: "",
      scanCode: "",
...
/* template functional */
var ch_unload___vue_template_functional__ = false
/* styles */
var ch_unload___vue_styles__ = ch_unload_injectStyle
/* scopeId */
var ch_unload___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var ch_unload___vue_module_identifier__ = null
var ch_unload_Component = ch_unload_normalizeComponent(
  machining_ch_unload,
  views_machining_ch_unload,
  ch_unload___vue_template_functional__,
  ch_unload___vue_styles__,
  ch_unload___vue_scopeId__,
  ch_unload___vue_module_identifier__
)

/* harmony default export */ var src_views_machining_ch_unload = (ch_unload_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/unload.vue
...
/* harmony default export */ var machining_unload = ({
  data: function data() {
    return {
      siteCode: "",
      scanCode: "",
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/unload.vue
...
/* harmony default export */ var views_machining_unload = ({
  data: function data() {
    return {
      siteCode: "",
      scanCode: "",
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-05523cce","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/machining/unload.vue
var machining_unload_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"macheineWorkInsert"},[_c('div',{staticClass:"convent"},[_c('div',{staticClass:"convent-input"},[_c('span',{staticStyle:{"width":"15rem","font-size":"18px","color":"#595959","line-height":"36px"}},[_vm._v(_vm._s(_vm.$t('message.productSerial')))]),_vm._v(" "),_c('el-input',{attrs:{"size":"40"},nativeOn:{"keyup":function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"enter",13,$event.key)){ return null; }_vm.show($event)}},model:{value:(_vm.code),callback:function ($$v) {_vm.code=$$v},expression:"code"}}),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.productionMachiningStatusChange()}}},[_vm._v("确定")]),_vm._v(" "),_c('span',{staticStyle:{"font-size":"14px","width":"120px","color":"#515152","vertical-align":"middle","float":"left","margin-left":"1.5rem"}},[_vm._v("已扫数量")]),_vm._v(" "),_c('span',{staticStyle:{"font-size":"36px","color":"#00AFEB","vertical-align":"middle","float":"left","margin-left":"10px","margin-right":"10px"}},[_vm._v(_vm._s(_vm.scan))]),_vm._v(" "),_c('span',[_vm._v("/")]),_vm._v(" "),_c('span',{staticStyle:{"font-size":"26px","color":"red","margin-left":"10px"}},[_vm._v(_vm._s(_vm.trayNumber))])],1)]),_vm._v(" "),_c('el-dialog',{attrs:{"title":"扫码绑定","visible":_vm.openDialog,"width":"50%","top":"200px"},on:{"update:visible":function($event){_vm.openDialog=$event}}},[_c('span',{staticStyle:{"width":"20%"}},[_vm._v("扫描码：")]),_vm._v(" "),_c('el-input',{attrs:{"size":"10"},model:{value:(_vm.scanCode),callback:function ($$v) {_vm.scanCode=$$v},expression:"scanCode"}}),_vm._v(" "),_c('span',{staticStyle:{"width":"20%"}},[_vm._v("序列号：")]),_vm._v(" "),_c('el-input',{model:{value:(_vm.code),callback:function ($$v) {_vm.code=$$v},expression:"code"}}),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.saveProductionRecordAndProductionAssembies()}}},[_vm._v("提交")]),_vm._v(" "),_c('span',{staticClass:"dialog-footer",attrs:{"slot":"footer"},slot:"footer"})],1),_vm._v(" "),_c('div',{staticClass:"bottom-form",staticStyle:{"margin-top":"0.5rem"}},[_c('el-table',{attrs:{"data":_vm.tableData,"border":"","max-height":"450"},on:{"selection-change":_vm.handleSelectionChange}},[_c('el-table-column',{attrs:{"type":"selection","width":"55"}}),_vm._v(" "),_c('el-table-column',{attrs:{"type":"index","label":"序号","width":"68"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"productionOrderNum","label":"工单编号","width":"200"}}),_vm._v(" "),_c('el-table-column',{attrs:{"width":"200","prop":"materialCode","label":"物料编号"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"materialText","width":"200","label":"物料描述"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"serialNo","width":"280","label":"产品序列号"}})],1),_vm._v(" "),_c('div',{staticStyle:{"height":"20px","line-height":"20px"}}),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.insertPalletizedRecords()}}},[_vm._v("打印")]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.replenishPrint()}}},[_vm._v("补打印")])],1),_vm._v(" "),_c('div',{staticClass:"history-info"},[_c('el-dialog',{attrs:{"visible":_vm.dialogTableVisible,"width":"90%"},on:{"update:visible":function($event){_vm.dialogTableVisible=$event}}},[_c('el-table',{attrs:{"data":_vm.gridData,"border":""}},[_c('el-table-column',{attrs:{"prop":"serialNo","label":"产品序列号"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"createUser","label":"操作人"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"materialCode","label":_vm.$t('message.materialCode')}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"materialText","label":_vm.$t('message.materialText')}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"productionOrderNum","label":"工单编号"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"scanTime","width":"180","label":"下线时间","formatter":_vm.dateFormat}})],1),_vm._v(" "),_c('div',{staticStyle:{"height":"20px","line-height":"20px"}}),_vm._v(" "),_c('el-pagination',{attrs:{"background":"","layout":"total,prev, pager, next","page-size":_vm.pagesize1,"total":_vm.total1},on:{"current-change":_vm.currentChange}})],1)],1),_vm._v(" "),_c('div',{staticStyle:{"display":"none"},attrs:{"id":"print"}},[_c('table',{attrs:{"width":"600","align":"center","border":"1"}},[_c('tr',[_c('td',{staticStyle:{"height":"50px"},attrs:{"colspan":"4"}},[_c('span',[_vm._v("GEELY")]),_vm._v(" "),_c('span',[_vm._v("工厂:"+_vm._s(_vm.siteCode))])])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("托序列号")]),_vm._v(" "),_c('td',{attrs:{"colspan":"2"}},[_vm._v(_vm._s(_vm.palletBarCode))]),_vm._v(" "),_c('td',{attrs:{"rowspan":"4","align":"center","valign":"middle"}},[_c('img',{attrs:{"src":_vm.imgsrc}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("物料编号")]),_vm._v(" "),_c('td',{attrs:{"colspan":"2"}},[_vm._v(_vm._s(_vm.printmaterialCode))])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("物料描述")]),_vm._v(" "),_c('td',{attrs:{"colspan":"2"}},[_vm._v(_vm._s(_vm.printmaterialText))])]),_vm._v(" "),_vm._m(0),_vm._v(" "),_c('tr',[_c('td',[_vm._v("装箱数")]),_vm._v(" "),_c('td',[_vm._v(_vm._s(_vm.count))]),_vm._v(" "),_c('td',[_vm._v("打印时间")]),_vm._v(" "),_c('td',[_vm._v(_vm._s(_vm.time))])]),_vm._v(" "),_vm._m(1)])]),_vm._v(" "),_c('el-dialog',{attrs:{"visible":_vm.dialogVisible,"width":"90%"},on:{"update:visible":function($event){_vm.dialogVisible=$event}}},[_c('el-table',{attrs:{"data":_vm.printdata,"border":"","highlight-current-row":""},on:{"current-change":_vm.handleCurrentChange}},[_c('el-table-column',{attrs:{"prop":"palletBarCode","label":"托盘码"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"materialCode","label":"物料编号"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"materialText","label":"物料描述"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"palletQuantity","label":"装箱数"}})],1),_vm._v(" "),_c('div',{staticStyle:{"height":"20px","line-height":"20px"}}),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.print1()}}},[_vm._v("打印")]),_vm._v(" "),_c('div',{staticStyle:{"height":"20px","line-height":"20px"}}),_vm._v(" "),_c('el-pagination',{attrs:{"background":"","layout":"total,prev, pager, next","page-size":_vm.pagesize,"total":_vm.total},on:{"current-change":_vm.currentChange1}})],1),_vm._v(" "),_c('div',{staticClass:"icon-pad-history",on:{"click":function($event){_vm.getHistoryInfo()}}})],1)}
var machining_unload_staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('tr',[_c('td'),_vm._v(" "),_c('td',{attrs:{"colspan":"2"}})])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('tr',[_c('td',{attrs:{"width":"20%"}}),_vm._v(" "),_c('td',{attrs:{"width":"20%"}}),_vm._v(" "),_c('td',{attrs:{"width":"30%"}}),_vm._v(" "),_c('td',{attrs:{"width":"30%"}})])}]
var machining_unload_esExports = { render: machining_unload_render, staticRenderFns: machining_unload_staticRenderFns }
/* harmony default export */ var selectortype_template_index_0_src_views_machining_unload = (machining_unload_esExports);
// CONCATENATED MODULE: ./src/views/machining/unload.vue
function machining_unload_injectStyle (ssrContext) {
  __webpack_require__("FKGm")
}
var machining_unload_normalizeComponent = __webpack_require__("VU/8")
/* script */
...
/* template functional */
var machining_unload___vue_template_functional__ = false
/* styles */
var machining_unload___vue_styles__ = machining_unload_injectStyle
/* scopeId */
var machining_unload___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var machining_unload___vue_module_identifier__ = null
var machining_unload_Component = machining_unload_normalizeComponent(
  views_machining_unload,
  selectortype_template_index_0_src_views_machining_unload,
  machining_unload___vue_template_functional__,
  machining_unload___vue_styles__,
  machining_unload___vue_scopeId__,
  machining_unload___vue_module_identifier__
)

/* harmony default export */ var src_views_machining_unload = (machining_unload_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/cs/load.vue
...
/* harmony default export */ var cs_load = ({
  data: function data() {
  ...
  methods: {
    ...
    validCSProductRecord: function validCSProductRecord() {
      var _this4 = this;
      ...
      if (this.count > 0 && /(^[1-9]\d*$)/.test(this.count)) {
        ...
        http(api.validCSProductRecord, body).then(function (response) {
          console.log(response);
          if (response.data.returnCode == "0") {
    ...
    handleCurrentChange: function handleCurrentChange(val) {
      ...
      http(api.getMachingHisRecords, body).then(function (response) {
        var resData = response.data.data;
        _this6.gridData = resData.list;
        _this6.total = resData.toalCount;
      });
    },
    ...
    current: function current(val, old) {
      ...
      if (val != null) {
        ...
        this.tableData.forEach(function (value, index, table) {
          if (table[index].productionOrderNum == old.productionOrderNum) {
            _this8.setCurrent(_this8.tableData[index]);
          }
        });
      }
    },
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/machining/cs/load.vue
...
/* harmony default export */ var machining_cs_load = ({
  data: function data() {
    return defineProperty_default()({
      centerDialogVisible: false,
      productionOrderNum: "",
...
/* template functional */
var cs_load___vue_template_functional__ = false
/* styles */
var cs_load___vue_styles__ = cs_load_injectStyle
/* scopeId */
var cs_load___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var cs_load___vue_module_identifier__ = null
var cs_load_Component = cs_load_normalizeComponent(
  machining_cs_load,
  views_machining_cs_load,
  cs_load___vue_template_functional__,
  cs_load___vue_styles__,
  cs_load___vue_scopeId__,
  cs_load___vue_module_identifier__
)

/* harmony default export */ var src_views_machining_cs_load = (cs_load_Component.exports);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/feed_material/feed_material.vue
//
//
//
//
...
/* harmony default export */ var feed_material = ({
  beforeRouteLeave: function beforeRouteLeave(to, from, next) {
    this.closeCom();
    next();
  },
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/feed_material/feed_material.vue
//
//
//
//
...
/* harmony default export */ var feed_material_feed_material = ({
  beforeRouteLeave: function beforeRouteLeave(to, from, next) {
    this.closeCom();
    next();
  },
...
/* template functional */
var feed_material___vue_template_functional__ = false
/* styles */
var feed_material___vue_styles__ = feed_material_injectStyle
/* scopeId */
var feed_material___vue_scopeId__ = "data-v-896d6838"
/* moduleIdentifier (server only) */
var feed_material___vue_module_identifier__ = null
var feed_material_Component = feed_material_normalizeComponent(
  feed_material_feed_material,
  views_feed_material_feed_material,
  feed_material___vue_template_functional__,
  feed_material___vue_styles__,
  feed_material___vue_scopeId__,
  feed_material___vue_module_identifier__
)

/* harmony default export */ var src_views_feed_material_feed_material = (feed_material_Component.exports);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-070db9de","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/menu/menu.vue
var menu_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"menu"},[_c('div',{staticClass:"detail"},[_c('router-link',{attrs:{"to":{name:'临时调用'},"tag":"div"}},[_vm._v("临时调用")])],1),_vm._v(" "),_vm._l((_vm.menu),function(item){return _c('div',{key:item.id,staticClass:"detail"},[_c('router-link',{attrs:{"to":{name:item.menuCode,params:{title:item.menuText}},"tag":"div"}},[_vm._v("\n      "+_vm._s(item.menuText)+"\n    ")])],1)})],2)}
...
/* scopeId */
var menu___vue_scopeId__ = "data-v-070db9de"
/* moduleIdentifier (server only) */
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2f49ac75","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/NotFound/NotFound.vue
...
/* scopeId */
var NotFound___vue_scopeId__ = "data-v-2f49ac75"
/* moduleIdentifier (server only) */
...
var routes = [{
    ...
    children: [{ path: '/assembly/load', component: src_views_assembly_load, name: 'AS_LOAD' }, { path: '/assembly/initialize', component: src_views_assembly_initialize, name: 'AS_INITIALIZE' }, { path: '/feed_material', component: src_views_feed_material_feed_material, name: 'FEED_MATERIAL' }, { path: '/assembly/repair', component: src_views_assembly_repair, name: 'AS_REPAIR' }, { path: '/assembly/pt/initialize', component: src_views_assembly_pt_initialize, name: 'PT_INITIALIZE' }, { path: '/assembly/unload', component: src_views_assembly_unload, name: 'AS_UNLOAD' }, { path: '/assembly/hottest', component: src_views_assembly_hottest, name: 'AS_HOTTEST' }, { path: '/machining/cs/load', component: src_views_machining_cs_load, name: 'CS_LOAD' }, { path: '/machining/unload', component: src_views_machining_unload, name: 'CS_UNLOAD' }, { path: '/machining/unload', component: src_views_machining_unload, name: 'CB_UNLOAD' }, { path: '/machining/load', component: src_views_machining_load, name: 'CH_LOAD' }, { path: '/machining/ch/unload', component: src_views_machining_ch_unload, name: 'CH_UNLOAD' }, { path: '/machining/load', component: src_views_machining_load, name: 'CB_LOAD' }, { path: '/machining/ch/initialize', component: src_views_machining_ch_initialize, name: 'CH_INITIALIZE' }, { path: '/temp', component: src_views_temp_temp, name: '临时调用' }, { path: '/menu', component: src_views_menu_menu, name: '菜单' }, { path: '/NotFound', component: src_views_NotFound_NotFound, name: '404' }, { path: '/system', component: src_views_system_systemconfiguration, name: 'system' }]
